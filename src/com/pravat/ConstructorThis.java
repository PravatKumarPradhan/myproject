...
public class ConstructorThis {
  ...
  public static  void main (String args []){
    ConstructorThis constructorThis=new ConstructorThis("Bapi",11);
  ...
  Stream<String> c=new Stream<String>() {
    @Override
    ...
    @Override
    public <A> A[] toArray(IntFunction<com.pravat.A[]> generator) {
      return null;
    }
    ...
    @Override
    public <R, A> R collect(Collector<? super String, com.pravat.A, R> collector) {
      return null;
    }
